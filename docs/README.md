...
| [agent-stream-sse.md](./agent-stream-sse.md) | Agent / API / frontend | `/api/agent-stream` SSE events, sync parity, client mapping |
...
| Agent SSE stream | `server/app/agent/orchestrator.py` (`stream_agent_events`), `client/src/agentStream.ts` |
